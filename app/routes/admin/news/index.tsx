...
export default function NewArticle() {
  ...
  const validateForPublish = (isPublish: boolean) => {
    ...
    if (!content || content.length === 0 || !content.some((s) => (s.content && s.content.trim()) || (s.items && s.items.some(Boolean)))) {
  ...
  const handleSubmit = async (e: React.FormEvent, publish = true) => {
    ...
    try {
      ...
      if (formData.imageCaption) fd.append("imageCaption", formData.imageCaption);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
                  ...
                  {featuredImage ? (
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 text-center">
                      ...
                      <div className="mt-4">
                        ...
                        <Input id="featured-upload" type="file" accept="image/*" onChange={handleImageUpload} className="hidden" />
                      </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <Button type="button" disabled={isSubmitting} onClick={(e) => handleSubmit(e as any, true)}>
                  {isSubmitting ? "Publishing..." : "Publish Article"}
                </Button>
                <Button type="button" variant="outline" disabled={isSubmitting} onClick={(e) => handleSubmit(e as any, false)}>
                  Save as Draft
                </Button>
              </div>
